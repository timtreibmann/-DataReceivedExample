// Generated by delombok at Tue Sep 05 21:35:25 CEST 2017
...
/**
 * @author ttreibmann Entschlüsselte Klasse Person mit allen durch die
 * Annotation
 * @DataReceived injizierten Quellcodestrukturen Diese Klasse ändert sich nicht
 * dynamisch! Sie zeigt nur alle Quelcodestrukturen statisch auf Eine
 * Veränderung bestimmter Parameter in der Klasse Person / Main haben auf diese
 * Klasse keine Auswirkungen
 * 
 * Getter/Setter Methoden durch @Getter generiert.
 */
    ...
    public void dataReceived(final de.sourcepark.smd.ocl.ConnectionEvent evt) {
        ...
        try {
            ...
            if (scpd.getCommand("VALID") != null) {
                ...
                scps.getCommand("ALIVE").addParam(new de.sourcepark.smd.base.util.scp.SCPParameter("Version", "string", de.sourcepark.smd.base.config.SMDConfiguration.getVersionString(Person.class)));
                queue.offer(scps);
